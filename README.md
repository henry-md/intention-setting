...
- The AI assistant reads `OPENAI_API_KEY` from Firebase Functions secrets and `OPENAI_CHAT_MODEL` from `web/functions/.env`. Do not put the OpenAI key in `extension/.env`.
